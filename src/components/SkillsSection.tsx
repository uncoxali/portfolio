...
export default function SkillsSection() {
  ...
  const skills = [
    ...
    { name: 'React Native', level: 85, category: 'Frontend', icon: FiCode },
    ...
    { name: 'Tailwind CSS', level: 85, category: 'UI Library', icon: FiLayout },
    { name: 'Material UI', level: 80, category: 'UI Library', icon: FiLayout },
    { name: 'shadcn/ui', level: 85, category: 'UI Library', icon: FiLayout },
    { name: 'Redux', level: 85, category: 'State Management', icon: FiDatabase },
    { name: 'Zustand', level: 80, category: 'State Management', icon: FiDatabase },
