...
export const metadata: Metadata = {
  ...
  keywords:
    'Frontend Developer, React, Next.js, TypeScript, Portfolio, JavaScript, UI/UX, Senior Developer, Web Development, Iran Developer',
  ...
  openGraph: {
    ...
    description:
      'Professional portfolio showcasing 6+ years of experience in frontend development with React, Next.js, and TypeScript',
    type: 'website',
    locale: 'en_US',
